                ...
                <View >
                  ...
                  que puse aca no esta bien</TextoComun>
                    ...
                    <View style={styles.contenedorIconos}>
                        <Image source={require("../../public/images/ducha-ne.png")} style={styles.imagenInputs} />
                        <Image source={require("../../public/images/toiletes-ne.png")} style={styles.imagenInputs} />
                        <Image source={require("../../public/images/wifi-ne.png")} style={styles.imagenInputs} />
...
/*  {!toogleList ?
                        (<View style={{ height: "100%", width: "50%" }}>
                            <Lista onPress={() => (setToogleList(!toogleList))}>Lista</Lista>
                        </View>)
                        : (<View style={{ height: "100%", width: "50%", borderBottomWidth: 3, borderColor: "white" }}>
                            <Lista style={{ color: "white" }} onPress={() => {
                                setToogleList(!toogleList)
                            }}>Lista</Lista>
                        </View>)}
                    {!toogleMap ?
                        (<View style={{ height: "100%", width: "50%" }}>
                            <Lista onPress={() => (setToogleMap(!toogleMap))}>Mapa</Lista></View>)
                        : (<View style={{ height: "100%", width: "50%", borderBottomWidth: 3, borderColor: "white" }}>
                            <Lista style={{ color: "white" }} onPress={() => {
                                setToogleMap(!toogleMap)
                            }}>Mapa</Lista>
                        </View>)}*/